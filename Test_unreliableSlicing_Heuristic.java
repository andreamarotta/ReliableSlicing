 ...
 */
public class Test_unreliableSlicing_Heuristic  {
...
//				
				...
				File file = new File(".\\UNR\\"+networkName+"_"+parameters.get("Bandwidth")
						+ "\\"+cap+"_"+ groom_string.get(g)+"_"+OPS.get(o) +"_Results_UNR_Heuristic_"+parameters.get("Virtualization")+"_"+parameters.get("Bandwidth")+"_M"+parameters.get("Mean")+"S"+parameters.get("Std")+".txt");
					...
					for (int i=20; i<201; i=i+20) //slices
					{
						...
						{ 
							//try {
								...
								System.out.println("Testing UNR Heuristic "+i+" slices on "+ networkName);
