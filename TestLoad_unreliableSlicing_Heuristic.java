 ...
 */
public class TestLoad_unreliableSlicing_Heuristic  {
...
//				FileWriter fileWriter = new FileWriter(".\\"+networkName+"_load_3\\"+cap+"_"+ groom_string.get(g)+"_"+OPS.get(o) +"_Results_PAL_Heuristic_"+parameters.get("Virtualization")+"_"+parameters.get("Bandwidth")+"_M"+parameters.get("Mean")+"S"+parameters.get("Std")+".txt",true);
//				FileWriter fileWriter_noRUs = new FileWriter(".\\"+networkName+"_load_3\\"+cap+"_"+ groom_string.get(g)+"_"+OPS.get(o) +"_Results_PAL_Heuristic_"+parameters.get("Virtualization")+"_"+parameters.get("Bandwidth")+"_M"+parameters.get("Mean")+"S"+parameters.get("Std")+"_noRUs.txt",true);
//				
				//FileWriter fileWriter = new FileWriter(".\\"+networkName+"\\"+cap+"_"+ groom_string.get(g)+"_"+OPS.get(o) +"_Results_PAL_Heuristic_"+parameters.get("Virtualization")+"_"+parameters.get("Bandwidth")+"_M"+parameters.get("Mean")+"S"+parameters.get("Std")+".txt",true);
				
				
				File file = new File(".\\UNR\\"+networkName+"_load_"+parameters.get("Bandwidth")+"\\"+cap+"_"+ groom_string.get(g)+"_"+OPS.get(o) +"_Results_UNR_Heuristic_"+parameters.get("Virtualization")+"_"+parameters.get("Bandwidth")+"_M"+parameters.get("Mean")+"S"+parameters.get("Std")+"_RUs.txt");

				File file_noRUs = new File(".\\UNR\\"+networkName+"_load_"+parameters.get("Bandwidth")+"\\"+cap+"_"+ groom_string.get(g)+"_"+OPS.get(o) +"_Results_UNR_Heuristic_"+parameters.get("Virtualization")+"_"+parameters.get("Bandwidth")+"_M"+parameters.get("Mean")+"S"+parameters.get("Std")+"_noRUs.txt");
				
				file.getParentFile().mkdirs();
				file_noRUs.getParentFile().mkdirs();

				FileWriter fileWriter = new FileWriter(file,false);
				FileWriter fileWriter_noRUs = new FileWriter(file_noRUs,false);
			
				
				
				PrintWriter printWriter = new PrintWriter(fileWriter);
				PrintWriter printWriter_noRUs = new PrintWriter(fileWriter_noRUs);
				
				for (int is=0; is<6;is++)//isolation
					for (int i=200; i<201; i=i+25) //slices
					{
						...
						{ 
							//try {
								...
								parameters.put("onlyplacement", String.valueOf((boolean) true));

								System.out.println("Testing Load UNR Heuristic "+i+" slices on "+ networkName);
								...
								printWriter.println(res.tot_load_ValuesAsString());//write to a file
								printWriter_noRUs.println(res.tot_load_noRUs_ValuesAsString());//write to a file
