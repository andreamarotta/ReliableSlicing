 ...
 */
public class TestLoad_reliableSlicingPAL_Heuristic  {
...
//				
				...
				File file = new File(".\\PAL\\"+networkName+"_load_"+parameters.get("Bandwidth")+"\\"+cap+"_"+ groom_string.get(g)+"_"+OPS.get(o) +"_Results_PAL_Heuristic_"+parameters.get("Virtualization")+"_"+parameters.get("Bandwidth")+"_M"+parameters.get("Mean")+"S"+parameters.get("Std")+".txt");

				File file_noRUs = new File(".\\PAL\\"+networkName+"_load_"+parameters.get("Bandwidth")+"\\"+cap+"_"+ groom_string.get(g)+"_"+OPS.get(o) +"_Results_PAL_Heuristic_"+parameters.get("Virtualization")+"_"+parameters.get("Bandwidth")+"_M"+parameters.get("Mean")+"S"+parameters.get("Std")+"_noRUs.txt");
				
				file.getParentFile().mkdirs();
				file_noRUs.getParentFile().mkdirs();

				FileWriter fileWriter = new FileWriter(file,false);
				FileWriter fileWriter_noRUs = new FileWriter(file,false);
					...
					for (int i=200; i<201; i=i+25) //slices
					{
						...
						{ 
							//try {
								...
								System.out.println("Testing Load PAL Heuristic "+i+" slices on "+ networkName);
